 ...
 */
class FastExcel_XLS2CSVTest {
	FastExcel_XLS2CSV instance
	...
	void file1(){
		...
		instance = new FastExcel_XLS2CSV(tf)
		instance.process()
...
*/
	...
	void testXLS_11969(){
		...
		instance = new FastExcel_XLS2CSV(tf.toPath().toString())
		instance.process()
